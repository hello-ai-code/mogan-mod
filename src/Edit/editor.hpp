...
#define TEXMACS_COPYRIGHT                                                      \
  (string ("(c) 1999-2020 by Joris van der Hoeven and others"))
...
protected:
  ...
  virtual void table_del_format (path fp, int I1, int J1, int I2, int J2,
                                 string var)                              = 0;
  virtual void table_insert (path fp, int row, int col, int nr_rows,
                             int nr_cols)                                 = 0;
  virtual void table_remove (path fp, int row, int col, int nr_rows,
                             int nr_cols)                                 = 0;
...
public:
  ...
  virtual void make_image (string file_name, bool link, string w, string h,
                           string x, string y)                           = 0;
  ...
  virtual void export_ps (url ps_name, string first= "1",
                          string last= "1000000")                         = 0;
