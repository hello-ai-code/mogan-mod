...
widget aligned_widget (array<widget> lhs, array<widget> rhs, SI hsep= 3 * PIXEL,
                       SI vsep= 3 * PIXEL, SI lpad= 0, SI rpad= 0);
...
widget resize_widget (widget w, int style, string w1, string h1, string w2,
                      string h2, string w3, string h3, string hpos,
                      string vpos);
