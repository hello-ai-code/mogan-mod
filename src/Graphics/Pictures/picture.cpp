...
color
mix (color c1, double a1, color c2, double a2) {
  return (color) mix (true_color (c1), a1, true_color (c2), a2);
}

color
mix (color c1, double a1, color c2, double a2, color c3, double a3, color c4,
     double a4) {
  return (color) mix (true_color (c1), a1, true_color (c2), a2, true_color (c3),
                      a3, true_color (c4), a4);
}
...
picture_rep::internal_smooth_pixel (double x, double y) {
  ...
  return mix (cx1y1, ix1 * iy1, cx1y2, ix1 * iy2, cx2y1, ix2 * iy1, cx2y2,
              ix2 * iy2);
}

void
picture_rep::internal_copy_from (int x, int y, picture src, int x1, int y1,
                                 int x2, int y2) {
...
void
picture_rep::internal_copy_to (int x, int y, picture dest, int x1, int y1,
                               int x2, int y2) {
  for (int yy= y1; yy < y2; yy++)
    for (int xx= x1; xx < x2; xx++)
