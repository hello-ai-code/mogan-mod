...
void
concat_box_rep::clear_incomplete (rectangles& rs, SI pixel, int i, int i1,
                                  int i2) {
  (void) pixel;
  (void) i;
  if (i1 < i2) {
...
void
concat_box_rep::loci (SI x, SI y, SI delta, list<string>& ids, rectangles& rs) {
