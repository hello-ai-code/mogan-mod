...
public:
  ...
  virtual void   insert_kbd_wildcard (string key, string im, bool post, bool l,
                                      bool r)                          = 0;
  ...
  virtual void   get_keycomb (string& s, int& status, command& cmd, string& sh,
                              string& help)                            = 0;
  ...
  virtual void change_auxiliary_widget_focus ()        = 0;
  virtual url  get_auxiliary_widget_parent_url ()      = 0;
  virtual void show_bottom_tools (int which, bool flag)= 0;
  virtual void show_chat_sidebar (bool flag)           = 0;
  virtual void show_outline_sidebar (bool flag)        = 0;
  ...
  virtual bool visible_chat_sidebar ()                 = 0;
  virtual bool visible_outline_sidebar ()              = 0;
