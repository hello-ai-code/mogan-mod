...
init_std_drd () {
  ...
  init (FREEZE, "freeze", fixed (1)->inner_border ()->regular (0));
  ...
  init (VSPACE, "vspace", options (1, 2)->length (0)->name ("vertical space"));
  init (SPACE, "space", options (1, 2)->length (0));
  // space markup has arity 1 or 3
  init (HTAB, "htab", options (1, 1, BIFORM)->length (0)->name ("tab"));
  init (MOVE, "move",
        fixed (3, 0, DETAILED)
            ->accessible (0)
            ->length (1)
  ...
  init (DLINES, "dlines",
        var_repeat (1, 1, BIFORM)->accessible (1)->name ("decorate lines"));
  init (DPAGES, "dpages",
        var_repeat (1, 1, BIFORM)->accessible (1)->name ("decorate pages"));
  init (DBOX, "dbox", fixed (0)->name ("decorated box"));
  init (LINE_NOTE, "line-note",
        fixed (1, 2, BIFORM)->length (1)->name ("line note"));
  init (PAGE_NOTE, "page-note",
        fixed (1, 2, BIFORM)->length (1)->name ("page note"));
  ...
  init (VAR_PAGE_BREAK, "page-break*", fixed (0)->name ("page break before"));
  ...
  init (NO_BREAK_END, "no-break-end", fixed (0)->name ("end no page breaks"));
  ...
  init (VAR_AROUND, "around*",
        fixed (3, 0, DETAILED)
            ->name (0, "left bracket")
            ->accessible (1)
            ->name (2, "right bracket"));
  init (BIG_AROUND, "big-around",
        fixed (2, 0, DETAILED)->name (0, "big operator")->accessible (1));
  ...
  init (LSUB, "lsub",
        fixed (1)
            ->name ("left subscript")
            ->accessible (0)
            ->locals (0, "math-display", "false"));
  init (LSUP, "lsup",
        fixed (1)
            ->name ("left superscript")
            ->accessible (0)
            ->locals (0, "math-display", "false"));
  init (RSUB, "rsub",
        fixed (1)
  ...
  init (WIDE, "wide", fixed (1, 1, BIFORM)->accessible (0)->name (1, "accent"));
  init (VAR_WIDE, "wide*",
        fixed (1, 1, BIFORM)
            ->accessible (0)
            ->name ("wide under")
  ...
  init (TFORMAT, "tformat",
        var_repeat (1, 1, BIFORM)
            ...
            ->name ("table format"));
  init (TWITH, "twith",
        fixed (2)->returns_adhoc ()->accessible (0)->binding (0)->name (
            "table property"));
  init (CWITH, "cwith",
        fixed (4, 2, BIFORM)
            ->returns_adhoc ()
  ...
  init (ASSIGN, "assign", fixed (1, 1, BIFORM)->variable (0)->regular (1));
  init (PROVIDE, "provide", fixed (1, 1, BIFORM)->variable (0)->regular (1));
  init (WITH, "with",
        var_repeat (2, 1, BIFORM)->with_like ()->binding (0)->accessible (1));
  init (PROVIDES, "provides", fixed (1)->returns_boolean ()->string_type (0));
  init (VALUE, "value", fixed (1)->variable (0)->locals (0, "mode", "src"));
  ...
  init (MACRO, "macro", var_repeat (1, 1, BIFORM)->argument (0)->regular (1));
  ...
  init (XMACRO, "xmacro", fixed (1, 1, BIFORM)->argument (0)->regular (1));
  ...
  init (IF, "if",
        options (2, 1, DETAILED)
            ...
            ->regular (2));
  init (VAR_IF, "if*",
        fixed (1, 1, BIFORM)->boolean (0)->name (0, "condition")->regular (1));
  init (CASE, "case", repeat (2, 1));
  init (DYNAMIC_CASE, "dynamic-case", repeat (2, 1));
  init (WHILE, "while", fixed (1, 1, BIFORM)->boolean (0)->regular (1));
  init (FOR_EACH, "for-each", fixed (1, 1, BIFORM)->variable (0)->regular (1));
  init (EXTERN, "extern",
  ...
  init (MINIMUM, "minimum", repeat (2, 1)->returns_numeric ()->numeric (0));
  init (MAXIMUM, "maximum", repeat (1, 1)->returns_numeric ()->numeric (0));
  init (MATH_SQRT, "math-sqrt",
        fixed (1)->returns_numeric ()->numeric (0)->name ("square root"));
  ...
  init (LOOK_UP, "look-up", fixed (1, 1, BIFORM)->regular (0)->integer (1));
  init (OCCURS_INSIDE, "occurs-inside",
        fixed (1, 1, BIFORM)->returns_boolean ()->regular (0)->argument (1));
  init (EQUAL, "equal", fixed (2)->returns_boolean ()->regular (0));
  init (UNEQUAL, "unequal",
        fixed (2)->returns_boolean ()->regular (0)->name ("not equal"));
  init (LESS, "less", fixed (2)->returns_boolean ()->regular (0));
  init (LESSEQ, "lesseq",
        fixed (2)->returns_boolean ()->regular (0)->name ("less or equal"));
  init (GREATER, "greater", fixed (2)->returns_boolean ()->regular (0));
  init (GREATEREQ, "greatereq",
        fixed (2)->returns_boolean ()->regular (0)->name ("greater or equal"));
  init (BLEND, "blend", fixed (2)->returns_color ()->color_type (0));
  init (RGB_COLOR, "rgb-color", options (3, 1)->returns_color ()->integer (0));
  ...
  init (MIDDLE_TAG, "middle-tag",
        repeat (1, 1, BIFORM)->variable (0)->name (0, "macro")->accessible (1));
  init (CLOSE_TAG, "close-tag",
        repeat (1, 1, BIFORM)->variable (0)->name (0, "macro")->accessible (1));
  init (SYMBOL, "symbol",
        fixed (1)->code (0)->name (0, "name")->locals (0, "mode", "src"));
  init (LATEX, "latex",
        fixed (1)->code (0)->name (0, "command")->locals (0, "mode", "src"));
  init (HYBRID, "hybrid",
        options (1, 1, BIFORM)
            ->variable (0)
            ->name (0, "command")
  ...
  init (ID, "id",
        repeat (1, 1)->returns_adhoc ()->accessible (0)->identifier (0));
  init (HARD_ID, "hard-id", options (0, 1)->returns_identifier ()->regular (0));
  init (LINK, "link",
        repeat (1, 1, BIFORM)
            ->returns_adhoc ()
            ->accessible (0)
  ...
  init (OBSERVER, "observer",
        fixed (1, 1, BIFORM)
            ...
            ->code (1)
            ->name (1, "call back"));
  init (FIND_ACCESSIBLE, "find-accessible", fixed (1)->regular (0));
  init (HLINK, "hlink",
        fixed (1, 1, BIFORM)
            ->accessible (0)
            ->name (0, "text")
  ...
  init (ACTION, "action",
        repeat (2, 1, DETAILED)
            ...
            ->regular (2)
            ->name (2, "arguments"));
  init (RELAY, "relay", repeat (1, 1)->accessible (0));
  init (SET_BINDING, "set-binding", options (1, 2)); // see env_exec.cpp
  ...
  init (HAS_BINDING, "has-binding",
        options (1, 1, BIFORM)
            ...
            ->integer (1)
            ->name (1, "kind"));
  init (HIDDEN_BINDING, "hidden-binding", fixed (2));
  init (LABEL, "label",
        fixed (1)->identifier (0)->name (0, "id")->long_name (0, "identifier"));
  ...
  init (PAGEREF, "pageref",
        fixed (1)
            ...
            ->identifier (0)
            ->name (0, "id")
            ->long_name (0, "identifier"));
  init (GET_ATTACHMENT, "get-attachment",
        fixed (1)->name ("get attachment")->identifier (0)->name (0, "name"));
  init (WRITE, "write",
        fixed (1, 1, BIFORM)
            ->string_type (0)
            ->name (0, "channel")
  ...
  init (ATTR, "attr",
        repeat (2, 2)->accessible (0)->binding (0)->name ("attributes"));
  init (TMLEN, "tmlen",
        options (1, 2)->returns_length ()->length (0)->name ("TeXmacs length"));
  init (COLLECTION, "collection", repeat (1, 1)->regular (0));
  init (ASSOCIATE, "associate", fixed (2)->binding (0));
  init (BACKUP, "backup", fixed (2)->regular (0));
  init (PATTERN, "pattern",
        options (3, 1, DETAILED)->returns_color ()->url_type (0));
  ...
  init (ANIM_STATIC, "anim-static",
        fixed (1, 3, BIFORM)->returns_animation ()->duration (1));
  init (ANIM_DYNAMIC, "anim-dynamic",
        fixed (1, 3, BIFORM)->returns_animation ()->duration (1));
  init (MORPH, "morph", repeat (1, 1)->regular (0));
  init (ANIM_TIME, "anim-time", fixed (0)->returns_duration ());
  init (ANIM_PORTION, "anim-portion", fixed (0)->returns_numeric ());
  init (ANIM_COMPOSE, "anim-compose",
        repeat (1, 1)->returns_animation ()->animation (0));
  init (ANIM_REPEAT, "anim-repeat",
        fixed (1)->returns_animation ()->accessible (0)->animation (0));
  init (
      ANIM_CONSTANT, "anim-constant",
      fixed (1, 1, BIFORM)->returns_animation ()->accessible (0)->duration (1));
  ...
  init (ANIM_PROGRESSIVE, "anim-progressive",
        fixed (1, 3, DETAILED)
            ...
            ->animation (0)
            ->duration (1));
  init (VIDEO, "video", fixed (1, 4, BIFORM)->url_type (0));
  init (SOUND, "sound", fixed (1)->url_type (0));

  init (GRAPHICS, "graphics", repeat (1, 1)->accessible (0)->graphical (0));
  ...
  */
  ...
  init (BEZIER, "bezier", repeat (2, 1)->returns_graphical ()->point_type (0));
  init (CBEZIER, "cbezier",
        repeat (3, 1)->returns_graphical ()->point_type (0));
  init (SMOOTH, "smooth", repeat (2, 1)->returns_graphical ()->point_type (0));
  ...
  init (CALLIGRAPHY, "calligraphy",
        fixed (4, 0, DETAILED)
            ...
            ->adhoc (3)
            ->name (3, "ink"));
  init (FILL, "fill", repeat (1, 1)); // Not yet implemented
  init (IMAGE, "image",
        fixed (1, 4, DETAILED)
            ->url_type (0)
            ->name (0, "url")
            ...
            ->length (3)
            ->name (3, "x")
            ->long_name (3, "x-offset")
            ->length (4)
            ->name (4, "y")
            ->long_name (4, "y-offset"));

  init (BOX_INFO, "box-info",
        fixed (1, 1, BIFORM)
            ->regular (0)
            ->            // content leading to box
        string_type (1)); // query
  init (FRAME_DIRECT, "frame-direct", fixed (1)->point_type (0));
  init (FRAME_INVERSE, "frame-inverse", fixed (1)->point_type (0));
  ...
  init (ON_TEXT_BORDER, "on-text-border",
        fixed (2)->returns_constraint ()->graphical_id (0));
  init (ON_GRID, "on-grid", fixed (2)->returns_constraint ()->graphical_id (0));

  init (TRANSFORM_3D, "transform-3d",
        fixed (1, 1, BIFORM)->returns_graphical ()->graphical (0));
  ...
  init (LIGHT_3D, "light-3d",
        fixed (1, 1, BIFORM)->returns_graphical ()->graphical (0));
  init (LIGHT_DIFFUSE, "light-diffuse", repeat (1, 1, BIFORM)->point_type (0));
  init (LIGHT_SPECULAR, "light-specular",
        repeat (2, 1, BIFORM)->point_type (0));
  ...
  init (EFF_GAUSSIAN, "eff-gaussian",
        options (1, 2, DETAILED)
            ->returns_effect ()
            ->length (0)
            ->name (0, "rx")
            ->long_name (0, "blur x-radius")
            ->length (1)
            ->name (1, "ry")
            ->long_name (1, "blur y-radius")
            ->numeric (2)
            ->name (2, "phi")
            ->long_name (2, "blur angle"));
  init (EFF_OVAL, "eff-oval",
        options (1, 2, DETAILED)
            ->returns_effect ()
            ->length (0)
            ->name (0, "rx")
            ->long_name (0, "x-radius")
            ->length (1)
            ->name (1, "ry")
            ->long_name (1, "y-radius")
            ->numeric (2)
            ->name (2, "phi")
            ->long_name (2, "angle"));
  ...
  init (EFF_DEGRADE, "eff-degrade",
        fixed (5, 0, DETAILED)
            ...
            ->length (1)
            ->name (1, "wx")
            ->long_name (1, "x-wave-length")
            ->length (2)
            ->name (2, "wy")
            ->long_name (2, "y-wave-length")
            ->numeric (3)
            ->name (3, "threshold")
            ->long_name (3, "threshold")
            ->numeric (4)
            ->name (4, "sharpness")
            ->long_name (4, "sharpness"));
  init (EFF_DISTORT, "eff-distort",
        fixed (5, 0, DETAILED)
            ...
            ->length (3)
            ->name (3, "rx")
            ->long_name (3, "x-radius")
            ->length (4)
            ->name (4, "ry")
            ->long_name (4, "y-radius"));
  ...
  init (EFF_ADD, "eff-add", repeat (1, 1)->returns_effect ()->effect (0));
  init (EFF_SUB, "eff-sub", repeat (1, 1)->returns_effect ()->effect (0));
  init (EFF_MUL, "eff-mul", repeat (1, 1)->returns_effect ()->effect (0));
  init (EFF_MIN, "eff-min", repeat (1, 1)->returns_effect ()->effect (0));
  init (EFF_MAX, "eff-max", repeat (1, 1)->returns_effect ()->effect (0));
  ...
  init (EFF_NORMALIZE, "eff-normalize",
        fixed (1)->returns_effect ()->effect (0)->name (0, "body"));
  ...
  init (ART_BOX, "art-box", repeat (1, 1, BIFORM)->accessible (0)->adhoc (1));

  init (FORMAT, "format", repeat (1, 1));
  init (LINE_SEP, "line-sep", fixed (0)->name ("line separator"));
  init (SPLIT, "split", repeat (1, 1));
  init (DELAY, "delay", fixed (1)->regular (0));
  init (HOLD, "hold", fixed (1)->regular (0));
  init (RELEASE, "release", fixed (1)->regular (0));
  ...
  init (SET, "set", fixed (1, 1, BIFORM)->variable (0)->regular (0));
  init (RESET, "reset", fixed (1)->variable (0));
  init (EXPAND, "expand", repeat (1, 1, BIFORM)->variable (0)->accessible (1));
  init (VAR_EXPAND, "expand*",
        repeat (1, 1, BIFORM)->inner_border ()->variable (0)->accessible (1));
  init (HIDE_EXPAND, "hide-expand", repeat (2, 1, DETAILED)->accessible (1));
  init (APPLY, "apply", repeat (1, 1, BIFORM)->variable (0));
  init (BEGIN, "begin", repeat (1, 1, BIFORM)->variable (0));
  init (END, "end", fixed (1)->variable (0));
  init (FUNC, "func", var_repeat (1, 1, BIFORM)->argument (0)->regular (1));
  init (ENV, "env", var_repeat (1, 2, BIFORM)->argument (0));
  init (AUTHORIZE, "authorize", fixed (2));
  init (POSTSCRIPT, "postscript", fixed (1, 6, BIFORM)->url_type (0));
