...
target("libmogan") do
    ...
    remove_files("src/Typeset/Boxes/Modifier/highlight_boxes.cpp")
    remove_files("src/Typeset/Boxes/Modifier/art_boxes.cpp")
    remove_files("src/Typeset/Boxes/Animate/animate_boxes.cpp")
