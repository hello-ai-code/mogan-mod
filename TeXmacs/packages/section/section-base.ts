...
<\body>
  ...
  <\active*>
    <\src-comment>
      ...
      \ \ <verbatim|x-unnumbered-title>: a macro for displaying an unnumbered
      title (including an optinal separator).
      ...
      \ \ <verbatim|x-post-sep>: an optional separator between the title and
  ...
  <assign|list-of-abbreviations|<\macro|body>
    ...
    <sectional-centered-bold|<very-large|<list-of-abbreviations-text>><vspace|1fn>>

    <tabular|<tformat|<twith|table-min-cols|2>|<twith|table-max-cols|2>|<twith|table-hyphen|y>|<cwith|1|-1|1|-1|cell-valign|c>|<twith|table-width|1par>|<twith|table-hmode|exact>|<cwith|1|-1|2|2|cell-hmode|exact>|<cwith|1|-1|1|1|cell-bsep|0.25fn>|<cwith|1|-1|1|1|cell-tsep|0.25fn>|<cwith|1|-1|1|1|cell-width|7em>|<cwith|1|-1|2|2|cell-width|33em>|<arg|body>>|>
  </macro>>
