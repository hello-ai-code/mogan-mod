...
("close search tool (Esc)" "关闭查找窗 (Esc)")
...
("disk" "圆盘")
("display style" "展示风格")
("Display enunciations inside wide frames" "在宽框中显示定理环境")
...
("first item" "")
("first occurrence (Home)" "第一项 (Home)")
("first page" "第一页")
...
("Local template file is missing" "本地模板文件缺失")
...
("march" "")
("marginal note" "边注")
("margins as on paper" "显示页边空白")
("margins on paper" "页边距")
("margins on screen" "屏幕边距")
("margins" "页边距")
("marked text" "高亮文本")
("marked" "高亮")
("master file" "")
...
("mathematics" "数学")
("matrix" "矩阵")
("maximal number of columns" "列数最大值")
("maximal number of rows" "行数最大值")
("maximal" "最大")
("maximum mode" "")
("maximum" "最大值")
("may" "")
...
("next field" "下一个区域")
("next line" "")
("next occurrence (PageDown)" "下一项 (PageDown)")
("next screen" "前一屏")
...
("Only search and replace in math mode" "仅在数学模式中查找替换")
("Only search and replace in text mode" "仅在文本模式中查找替换")
("Only search in Program mode" "仅在代码模式中查找")
("Graphics mode cannot search" "绘图模式无法查找")
("Only search and replace in Program mode" "仅在代码模式中查找替换")
...
("path" "路径")
("pattern" "图案")
("PDF engine not available" "PDF引擎不可用")
("PDF render error: %1" "PDF渲染错误: %1")
...
("previous occurrence (PageUp)" "上一项 (PageUp)")
("previous screen" "后一屏")
...
("Received empty image data" "收到的图片数据为空")
...
("running title" "栏外标题")
("russian" "俄语")
("same screen margins as on paper" "保持屏幕边距和页边距一致")
("sample text" "示例文本")
("sample" "示例")
("sans serif" "")
...
("Search and replace preferences" "查找替换偏好设置")
("Search preferences" "查找偏好设置")
...
("Subscribing" "订阅中")
("subsection" "小节")
("Subsection numbering" "小节编号")
("subsub" "小项")
("subsubmenu" "二级子菜单")
("subsubsection" "子节")
("subsubsubmenu" "三级子菜单")
("subsubsubsubmenu" "四级子菜单")
("Subsubsection numbering" "子节编号")
("subtable" "子表格")
("subtitle" "副标题")
...
("warning" "警告")
("wave" "波浪")
("Welcome to Liii STEM" "欢迎使用 Liii STEM")
("Welcome to Liii STEM!" "欢迎使用 Liii STEM！")
("web" "网站")
