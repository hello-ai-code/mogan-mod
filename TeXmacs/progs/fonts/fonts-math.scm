...
(set-font-rules '(;; Main math font
                  ...
                  ((roman ms medium right $s $d)
                   (math-var ecss cmss cmmi $s $d))
                  ((roman ms bold right $s $d)
                   (bold-math-var ecsx cmssbx cmmib $s $d))
                  ((roman mt medium right $s $d)
                   (math-var ectt cmtt cmmi $s $d))
                  ((roman mr medium $a $s $d) (math-std ecrm cmr cmmi $s $d))
                  ((roman mr bold $a $s $d)
                   (bold-math-std ecbx cmbx cmmib $s $d))
                  ((roman ms light $a $s $d)
                   (math-bright cmbr cmbr cmbrmi $s $d))
                  ((roman ms medium $a $s $d)
                   (math-alt ecss ecsi cmss cmmi $s $d))
                  ((roman ms bold $a $s $d)
                   (math-alt ecsx ecso cmssbx cmmib $s $d))
                  ((roman mt medium $a $s $d)
                   (math-alt ectt ecst cmtt cmitt $s $d))
                  ((roman trm medium $a $s $d) (math-var ecrm cmr cmmi $s $d))
                  ((roman trm bold $a $s $d)
                   (bold-math-var ecbx cmbx cmmib $s $d))
                  ((roman tss medium $a $s $d) (math-var ecss cmss cmmi $s $d))
                  ((roman tss bold $a $s $d)
                   (bold-math-var ecsx cmssbx cmmib $s $d))
                  ...
                  ((concrete mr medium right $s $d)
                   (math-conc-var eorm ccr xcmmi $s $d))
                  ((concrete mr bold right $s $d)
                   (math-conc-var ecbx cmbx cmmib $s $d))
                  ((concrete ms medium right $s $d)
                   (math-alt ecss ecsi cmss cmmi $s $d))
                  ((concrete ms bold right $s $d)
                   (math-alt ecsx ecso cmssbx cmmib $s $d))
                  ((concrete mt medium right $s $d)
                   (math-alt ectt ecst cmtt cmmi $s $d))
                  ((concrete mr medium $a $s $d)
                   (math-conc eorm ccr xccmi $s $d))
                  ((concrete mr bold $a $s $d)
                   (bold-math-std ecbx cmbx cmmib $s $d))
                  ((concrete ms light $a $s $d)
                   (math-bright cmbr cmbr cmbrmi $s $d))
                  ((concrete ms medium $a $s $d)
                   (math-std ecss cmss cmssi $s $d))
                  ((concrete ms bold $a $s $d)
                   (math-std ecsx cmssbx cmmib $s $d))
                  ((concrete mt medium $a $s $d)
                   (math-std ectt cmtt cmitt $s $d))
                  ((concrete trm medium $a $s $d)
                   (math-conc-var eorm ccr xcmmi $s $d))
                  ((concrete trm bold $a $s $d)
                   (math-conc-var ecbx cmbx cmmib $s $d))
                  ((concrete tss medium $a $s $d)
                   (math-var ecss cmss cmmi $s $d))
                  ((concrete tss bold $a $s $d)
                   (math-var ecsx cmssbx cmmib $s $d))
...
(set-font-rules '(((unicode-math $up $it $bup $bit $t $a $b $s $d)
                   (unimath (unicode $up $s $d)
                     (unicode $it $s $d)
                     (unicode $bup $s $d)
                     (unicode $bit $s $d)
                     (roman $t $a $b $s $d)))
