...
(set-font-rules '(((avant-garde rm medium right $s $d)
                   (ec avant-garde-rm $s $d))
                  ((avant-garde rm medium slanted $s $d)
                   (ec avant-garde-ti $s $d))
                  ((avant-garde rm medium italic $s $d)
                   (ec avant-garde-ti $s $d))
                  ((avant-garde rm bold right $s $d) (ec avant-garde-bx $s $d))
                  ((avant-garde rm bold slanted $s $d)
                   (ec avant-garde-bi $s $d))
                  ((avant-garde rm bold italic $s $d) (ec avant-garde-bi $s $d))
                  ((avant-garde ss $series $shape $s $d)
                   (avant-garde rm $series $shape $s $d))
                  ((avant-garde tt $series $shape $s $d)
                   (courier rm $series $shape $s $d))
                  ...
                  ((bookman ss $series $shape $s $d)
                   (avant-garde rm $series $shape $s $d))
                  ((bookman tt $series $shape $s $d)
                   (courier rm $series $shape $s $d))
                  ...
                  ((courier ss $series $shape $s $d)
                   (helvetica rm $series $shape $s $d))
                  ((courier tt $series $shape $s $d)
                   (courier rm $series $shape $s $d))
                  ...
                  ((helvetica ss $series $shape $s $d)
                   (helvetica rm $series $shape $s $d))
                  ((helvetica tt $series $shape $s $d)
                   (courier rm $series $shape $s $d))
                  ((new-century-schoolbook rm medium right $s $d)
                   (ec nc-schoolbook-rm $s $d))
                  ((new-century-schoolbook rm medium slanted $s $d)
                   (ec nc-schoolbook-ti $s $d))
                  ((new-century-schoolbook rm medium italic $s $d)
                   (ec nc-schoolbook-ti $s $d))
                  ((new-century-schoolbook rm bold right $s $d)
                   (ec nc-schoolbook-bx $s $d))
                  ((new-century-schoolbook rm bold slanted $s $d)
                   (ec nc-schoolbook-bi $s $d))
                  ((new-century-schoolbook rm bold italic $s $d)
                   (ec nc-schoolbook-bi $s $d))
                  ((new-century-schoolbook ss $series $shape $s $d)
                   (helvetica rm $series $shape $s $d))
                  ((new-century-schoolbook tt $series $shape $s $d)
                   (courier rm $series $shape $s $d))
                  ...
                  ((palatino ss $series $shape $s $d)
                   (helvetica rm $series $shape $s $d))
                  ((palatino tt $series $shape $s $d)
                   (courier rm $series $shape $s $d))
                  ...
                  ((times ss $series $shape $s $d)
                   (helvetica rm $series $shape $s $d))
                  ((times tt $series $shape $s $d)
                   (courier rm $series $shape $s $d))
                  ;; old style
                  ((helvetica rm medium condensed $s $d)
                   (adobe rphvrrn $s $d 0))
                  ((helvetica rm medium slanted-condensed $s $d)
                   (adobe rphvron $s $d 0))
                  ((helvetica rm medium italic-condensed $s $d)
                   (adobe rphvron $s $d 0))
                  ((helvetica rm bold condensed $s $d) (adobe rphvbrn $s $d 0))
                  ((helvetica rm bold slanted-condensed $s $d)
                   (adobe rphvbon $s $d 0))
                  ((helvetica rm bold italic-condensed $s $d)
                   (adobe rphvbon $s $d 0))
                  ((palatino rm medium italic-right $s $d)
                   (adobe rpplru $s $d 0))
...
(set-font-rules '(((adobe $f medium $a $s $d)
                   (math (adobe-math (tex cmr $s $d)
                           (tex cmmi $s $d)
                           (tex cmsy $s $d)
                           (tex msam $s $d)
                           (tex msbm $s $d)
