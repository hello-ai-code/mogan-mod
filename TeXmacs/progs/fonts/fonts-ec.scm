...
(set-font-rules '(((roman rm medium right $s $d) (ec ecrm $s $d))
                  ...
                  ((roman rm medium $a $s $d) (ec ecrm $s $d))
                  ...
                  ((roman rm bold $a $s $d) (ec ecbx $s $d))
                  ((roman rm $a $b $s $d) (ec ecrm $s $d))
                  ...
                  ((roman ss medium $a $s $d) (ec ecss $s $d))
                  ...
                  ((roman ss bold $a $s $d) (ec ecsx $s $d))
                  ((roman ss $a $b $s $d) (ec ecss $s $d))
                  ...
                  ((concrete rm $a $b $s $d) (ec eorm $s $d))
                  ...
                  ((concrete tt $a $b $s $d) (ec ectt $s $d))
                  ...
                  ((concrete ss $a $b $s $d) (ec ecss $s $d))
                  ((pandora rm medium right $s $d) (ec pnr $s $d))
                  ((pandora rm medium slanted $s $d) (ec pnsl $s $d))
                  ((pandora rm medium italic $s $d) (ec pnsl $s $d))
                  ((pandora rm bold right $s $d) (ec pnb $s $d))
                  ((pandora tt $a right $s $d) (ec pntt $s $d 9))
                  ((pandora tt-ss $a right $s $d) (ec pntt $s $d 9))
                  ((pandora ss medium right $s $d) (ec pnss $s $d))
                  ((pandora ss medium slanted $s $d) (ec pnssi $s $d))
                  ((pandora ss medium italic $s $d) (ec pnssi $s $d))
                  ((pandora ss bold right $s $d) (ec pnssb $s $d))
                  ((cal rm bold $a $s $d) (tex cmbsy $s $d))
                  ((cal rm $a $b $s $d) (tex cmsy $s $d))
                  ...
                  ((Bbb* rm bold $a $s $d) (tex bbmbx $s $d))
                  ((Bbb* ss medium italic $s $d) (tex bbmssi $s $d))
